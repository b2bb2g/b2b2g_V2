...
| T-052 | Sprint 2 Organization Engine Task 04 - Queries | Codex | TODO | `lib/queries/organization.ts` | T-051 | Add compatibility-safe organization queries and PII-safe DTOs. |
...
| T-056 | Sprint 2 Organization Engine Task 08 - Review and Freeze | Codex | TODO | `docs/09-sprints/09-sprint-2-organization-review-and-freeze.md` | T-055 | Review Sprint 2 compliance and freeze known limitations. |
