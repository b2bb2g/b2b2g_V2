...
| T-062 | Sprint 2 Invitation Engine Task 05 - Queries and Actions | Codex | TODO | `lib/queries/invitations.ts`, `lib/actions/invitations.ts` | T-061 | Add server-safe invitation reads/writes without service role fallback. |
| T-063 | Sprint 2 Invitation Engine Task 06 - Supplier Public Signup Flow | Codex | TODO | Supplier signup route/action candidates | T-062 | Connect Supplier public signup to role application and approval flow without Buyer PII exposure. |
| T-064 | Sprint 2 Invitation Engine Task 07 - Admin Invite Flow | Codex | TODO | Admin invitation page/action candidates | T-062 | Implement minimal Admin invitation issue/revoke flow after security review. |
| T-065 | Sprint 2 Invitation Engine Task 08 - Buyer/Student Parent Invite Flow | Codex | TODO | Buyer/Student parent invitation candidates | T-064 | Implement Agent-Buyer and Professor-Student invitation flows with relation candidates. |
| T-066 | Sprint 2 Invitation Engine Task 09 - QR URL Generation | Codex | TODO | QR URL helper candidates | T-065 | Generate QR from token URL only unless asset storage is explicitly approved. |
| T-067 | Sprint 2 Invitation Engine Task 10 - Tests | Codex | TODO | Invitation tests | T-066 | Verify token validation, duplicate redemption prevention, parent-link requirements, and PII boundaries. |
| T-068 | Sprint 2 Invitation Engine Task 11 - Review/Freeze | Codex | TODO | `docs/09-sprints/14-sprint-2-invitation-review-and-freeze.md` | T-067 | Review Invitation Engine compliance and freeze known limitations before resuming Organization expansion. |
