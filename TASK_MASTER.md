...
| T-050 | Sprint 2 Organization Implementation Plan | Codex | TODO | `docs/09-sprints/08-sprint-2-organization-implementation-plan.md` | T-049 | Define type/query/action/test sequence before Organization code edits or migration planning. |
