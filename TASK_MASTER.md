...
| T-058 | Sprint 2 Invitation Engine Repository Audit / Implementation Plan | Codex | TODO | `docs/09-sprints/11-sprint-2-invitation-engine-plan.md` | T-057 | Audit signup/invitation code paths and plan Supplier/Agent/Buyer/Professor/Student invitation implementation. |
