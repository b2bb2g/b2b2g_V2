...
| T-049 | Sprint 2 Organization Engine Plan and Repository Audit | Codex | TODO | `docs/09-sprints/07-sprint-2-organization-engine-plan.md` | T-048 | Start Sprint 2 with Organization Engine scope, relation model, repository audit, and no code-first implementation. |
