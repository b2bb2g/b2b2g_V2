...
| T-060 | Sprint 2 Invitation Engine Task 03 - Migration Spec | Codex | TODO | `docs/09-sprints/13-sprint-2-invitation-migration-spec.md` | T-059 | Specify invitation tables, token hashing, relation candidates, and rollback before SQL authoring. |
| T-061 | Sprint 2 Invitation Engine Task 04 - Types and Helpers | Codex | TODO | `lib/auth/invitations.ts`, invitation helper tests | T-060 | Add pure invitation helper types after migration spec; do not touch production DB. |
