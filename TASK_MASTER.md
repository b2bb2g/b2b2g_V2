...
| T-051 | Sprint 2 Organization Engine Task 03 - Types and Helper | Codex | TODO | `lib/auth/organization.ts`, organization helper tests | T-050 | Add local Organization relation types and pure helper functions without DB migration or UI changes. |
