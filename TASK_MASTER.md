...
| T-063 | Sprint 2 Invitation Engine Task 06 - Queries and Actions | Codex | TODO | `lib/queries/invitations.ts`, `lib/actions/invitations.ts` | T-062 | Add server-safe invitation reads/writes without service role fallback after RLS/app boundary review. |
| T-064 | Sprint 2 Invitation Engine Task 07 - Supplier Public Signup Flow | Codex | TODO | Supplier signup route/action candidates | T-063 | Connect Supplier public signup to role application and approval flow without Buyer PII exposure. |
