...
| T-059 | Sprint 2 Invitation Engine Task 02 - Repository Audit | Codex | TODO | `docs/09-sprints/12-sprint-2-invitation-repository-audit.md` | T-058 | Audit existing auth/signup/invitation-like code paths before SQL or implementation. |
